...
library (ape)
SpalChromtree<-read.tree("./CypSpalink.tree")
...
setwd("./Nodo 4-3 Spalink")
Nodo433<-read.table("Nodo4-3_chrom_Spalink - copia.txt", header=F,sep=";") 
Nodo43<-as.character(Nodo433[,1]) #Convierto en caracter, porque es obligatorio para hacer el pruning
# Saco el Nodo 4-3
Nodo43tree<-drop.tip(phy=SpalChromtree, setdiff(SpalChromtree$tip.label,Nodo43))
...
setwd("./Nodo 4-2-1 Spalink")
Nodo4211<-read.table("Nodo4-2-1_chrom_Spalink - copia.txt", header=F,sep=";")  
Nodo421<-as.character(Nodo4211[,1]) #Convierto en caracter, porque es obligatorio para hacer el pruning
# Saco el Nodo 4-2-1
Nodo421tree<-drop.tip(phy=SpalChromtree, setdiff(SpalChromtree$tip.label,Nodo421))
